...
TString filenamepath("/afs/hep.wisc.edu/cms/khurana/Script/CMSSW_7_4_1/src/DarkMatterBkg/'''+inputdirname+'''/"); 
// DYJets 1
...
dirnames=['histfacFatJet_ZLight','histfacFatJet_WHeavy']
...
for dirname in dirnames:
    ...
    if makeLinearplots :
        ...
        makeplot([dirname,'h_cutFlow0','','0','6','1','1','1','','0']) ## last option 0 means data will be plotted
