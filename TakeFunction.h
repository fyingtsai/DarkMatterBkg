...
int TakeFunction::getFatJetIndex(TreeReader &data)
{
...
TLorentzVector TakeFunction::getSecondFatJetLorentz(TreeReader &data,TLorentzVector* maxFJet)
{
    const TClonesArray* FatJetP4 = (TClonesArray*) data.GetPtrTObject("FATjetP4");
    const Int_t nJet             = data.GetInt("FATnJet");
    const vector<bool> &FATjetPassIDLoose = *((vector<bool>*) data.GetPtr("FATjetPassIDLoose"));
...
TLorentzVector TakeFunction::getQCDJetTLorentz(TreeReader &data,TLorentzVector* maxFJet)
{
...
int TakeFunction::numThinJet(TreeReader &data,TLorentzVector* maxFJet)
{
...
int TakeFunction::numEle(TreeReader &data,TLorentzVector* maxFJet)
{
...
int TakeFunction::numMuon(TreeReader &data,TLorentzVector* maxFJet)
{
...
int TakeFunction::numTau(TreeReader &data,TLorentzVector* maxFJet)
{
...
bool TakeFunction::isPassPhiMETFJet(TreeReader &data,TLorentzVector* maxFJet)
{
