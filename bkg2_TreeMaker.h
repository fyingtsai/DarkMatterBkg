...
// Thu Nov  5 17:15:52 2015 by ROOT version 6.02/05
...
#ifdef testFile_cxx
testFile::testFile(TTree *tree) : fChain(0) 
{
...
Int_t testFile::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t testFile::LoadTree(Long64_t entry)
{
...
void testFile::Show(Long64_t entry)
{
...
Int_t testFile::Cut(Long64_t entry)
{
